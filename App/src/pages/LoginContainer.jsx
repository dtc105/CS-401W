    ...
    return (
        <div class="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
            <div className="flex flex-row  justify-center gap-3 pb-4">
                    ...
                    <h1 className="text-3xl font-bold text-[#4B5563] my-auto text-center">Welcome back!</h1>
            ...
            <form class="flex flex-col">
                ...
                <div class="text-sm font-light text-[#6B7280] text-center">Don't have an account yet? <a href="/register" class="font-medium text-[#4F46E5] hover:underline">Register</a>
